...
return [
    ...
    'first_course_warning' => 'Из-за того что у первых курсов форма обучения будет в онлайн формате, общежитие в этом семестре не будет принимать студентов первого курса',
];
